        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-lg text-foreground">Continue as Customer</div>
              <div className="text-sm text-muted-foreground mt-0.5">Book rides and manage your trips</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-lg text-foreground">Continue as Driver</div>
              <div className="text-sm text-muted-foreground mt-0.5">Accept trips and earn money</div>
            </div>
          </button>
        </div>
      </div>
