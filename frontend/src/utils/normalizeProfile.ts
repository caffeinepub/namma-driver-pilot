 ...
 */
export type NormalizedDriverProfile = Omit<UserProfile, 'vehicleExperience' | 'transmissionComfort' | 'languages'> & {
 ...
 */
export function normalizeDriverProfile(profile: UserProfile): NormalizedDriverProfile {
  return {
    ...(profile as Omit<UserProfile, 'vehicleExperience' | 'transmissionComfort' | 'languages'>),
