...
import { Hash, Settings2, ShieldCheck, User } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const { data: userProfile, isError: profileError } =
  ...
  const KNOWN_ADMIN_PRINCIPAL =
    "6ngnc-ph7ou-g23nw-z2zbr-czprs-ohpe6-2wolp-eeo7o-c32lo-deiso-yqe";
  const isKnownAdmin = principalId === KNOWN_ADMIN_PRINCIPAL;
  const displayName = isKnownAdmin
    ? "Ramesh Admin"
    : (userProfile?.fullName ?? "—");
  const displayEmail = isKnownAdmin
    ? "admin@nammadriver.in"
    : (userProfile?.email ?? "—");
      ...
      <div className="mb-8 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Manage users and monitor all trips across the platform
          </p>
        </div>
      </div>
        ...
        <TabsContent value="trips" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete trip history across the platform
              </CardDescription>
            </CardHeader>
            <CardContent>
              <AdminTripsTab />
        ...
        <TabsContent value="pricing" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View and edit platform pricing parameters. Changes take effect
