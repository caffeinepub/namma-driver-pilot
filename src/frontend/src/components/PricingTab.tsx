...
export default function PricingTab() {
  ...
  const [vehicleMultiplier, setVehicleMultiplier] = useState(
    EMPTY_CONFIG.vehicle_multiplier,
  );
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Rates for local trips within the city
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <NumericField
            ...
            onChange={(v) =>
              setLocal((p) => ({ ...p, per_min_after_first_hour: v }))
            }
            disabled={isSaving}
          />
          <NumericField
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <NumericField
            ...
            onChange={(v) =>
              setOutstation((p) => ({ ...p, driver_bata_per_day: v }))
            }
            disabled={isSaving}
          />
          <NumericField
            ...
            onChange={(v) =>
              setOutstation((p) => ({ ...p, commission_rate: v }))
            }
            disabled={isSaving}
          />
          <NumericField
            ...
            onChange={(v) =>
              setOutstation((p) => ({ ...p, km_slab_1_limit: v }))
            }
            disabled={isSaving}
          />
          <NumericField
            ...
            onChange={(v) =>
              setOutstation((p) => ({ ...p, km_slab_2_limit: v }))
            }
            disabled={isSaving}
          />
          <NumericField
            ...
            onChange={(v) =>
              setOutstation((p) => ({ ...p, km_slab_3_limit: v }))
            }
            disabled={isSaving}
          />
          <NumericField
          ...
          <NumericField
            ...
            onChange={(v) =>
              setOutstation((p) => ({
                ...p,
                extra_driver_comp_per_100km_over_400: v,
              }))
            }
            disabled={isSaving}
          />
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <NumericField
            ...
            onChange={(v) =>
              setVehicleMultiplier((p) => ({ ...p, hatchback: v }))
            }
            disabled={isSaving}
          />
          <NumericField
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Platform commission (0–1 range, e.g. 0.20 = 20%)
          </CardDescription>
        </CardHeader>
