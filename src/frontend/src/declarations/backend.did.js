...
export const AcceptTripResult = IDL.Variant({
  'ok' : Trip,
  'offDuty' : IDL.Null,
  'tripNotFound' : IDL.Null,
...
export const DriverProfile = IDL.Record({
  ...
  'aadharBackBase64' : IDL.Text,
  'bankAccount' : IDL.Text,
  'servicePincode' : IDL.Text,
  'vehicleExperience' : IDL.Vec(VehicleType),
  'bankUPI' : IDL.Text,
  'dlPhotoBase64' : IDL.Text,
  'languages' : IDL.Vec(IDL.Text),
  'isAvailable' : IDL.Bool,
  'fullName' : IDL.Text,
  'aadharFrontBase64' : IDL.Text,
  'bankIFSC' : IDL.Text,
  'bankName' : IDL.Text,
  'vehicleTypes' : IDL.Vec(IDL.Text),
  'aadharNumber' : IDL.Text,
  'transmissionTypes' : IDL.Vec(IDL.Text),
  'dlNumber' : IDL.Text,
  'transmissionComfort' : IDL.Vec(TransmissionType),
  'mobile' : IDL.Text,
  'selfieBase64' : IDL.Text,
  'luxuryVehicleDetails' : IDL.Text,
});
...
export const idlFactory = ({ IDL }) => {
  ...
  const AcceptTripResult = IDL.Variant({
    'ok' : Trip,
    'offDuty' : IDL.Null,
    'tripNotFound' : IDL.Null,
    'unauthorized' : IDL.Null,
